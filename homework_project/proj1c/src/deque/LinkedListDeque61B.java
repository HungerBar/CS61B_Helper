...
public class LinkedListDeque61B<T> implements  Deque61B<T> {
    ...
    public boolean equals(Object x) {
        if(x instanceof LinkedListDeque61B<?> linkedListDeque61B) {
            if(size() == linkedListDeque61B.size()) {
                for(int i = 0; i < linkedListDeque61B.size(); i++) {
                    if(!this.get(i).equals(linkedListDeque61B.get(i))) {
                        return false;
                    }
                }return true;
            }
